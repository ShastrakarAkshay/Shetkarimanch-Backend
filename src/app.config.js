...
const CONFIG = {
  ...
  REGISTER_OTP_SECRET_KEY: process.env.REGISTER_OTP_SECRET_KEY || "sm-reg-otp-secret-key",
  ...
  SERVER_URL: process.env.SERVER_URL || "http://shetkimanch-env.eba-5kwfspmw.us-east-2.elasticbeanstalk.com",
};
